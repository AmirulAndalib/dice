...
// 			expected:   []interface{}{"OK", int64(6), "™ž", int64(6), "foobar"},
...
// 			expected:   []interface{}{"OK", int64(2), "ÎÏ", int64(2), int64(10)},
// 			assertType: []string{"equal", "equal", "equal", "equal", "equal"},
// 		},
// 		{
...
// 			expected:   []interface{}{"OK", int64(0), int64(6), "gïofev", int64(1), int64(0), int64(7), "goofev@"},
// 			assertType: []string{"equal", "equal", "equal", "equal", "equal", "equal", "equal", "equal"},
// 		},
// 		{
